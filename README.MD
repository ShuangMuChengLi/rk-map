...
41. 多个点位  地图居中 -- rkMap.fitViewZoom(pointList); var pointList = [{ id: '1', lonLat: [118.15, 24.51], text: '1'}, {id: '2', lonLat: [118.14, 24.5],text: '2'}
...
45. mapServiceObj的projection和RKMap的projection区别
46. 不设置projection，updateView失效
